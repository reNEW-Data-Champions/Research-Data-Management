...
| **Team Awareness Requirements**    | <p>All team members should know:</p><p>1. Where the data is stored, including backups</p><p>2. Who can access the data, and how (authentication/permissions)</p><p>3. How data is organized and documented, including folder structures, file naming, metadata, and README files</p>           |
